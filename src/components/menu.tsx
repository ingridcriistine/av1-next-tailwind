...
export const Menu: React.FC<MenuProps> = ({op1, op2, op3}) => {
    return(
        <nav className="text-preto bg-blue justify-evenly p-3w-full z-10 h-[80px] flex items-center justify-center font-robFont text-large flex flex-row justify-center align-center gap-8">
